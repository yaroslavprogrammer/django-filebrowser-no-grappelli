...
from filebrowser.functions import url_join
...
class FileBrowseWidget(Input):
    ...
    class Media:
        css = {'all': (os.path.join(URL_FILEBROWSER_MEDIA, 'css/addfilebrowser.css'),)}
    ...
    def __init__(self, attrs={}):
        ...
        self.subdirectory = attrs.get('subdirectory', '')
    ...
    def render(self, name, value, attrs=None):
        ...
        final_attrs['subdirectory'] = self.subdirectory
        site = self.site
        if value != "":
            try:
...
class FileBrowseField(CharField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.subdirectory = kwargs.pop('subdirectory', '')
    ...
    def formfield(self, **kwargs):
        ...
        attrs["subdirectory"] = self.subdirectory
        if self.subdirectory:
            attrs["directory"] = os.path.join(self.directory, self.subdirectory)
        defaults = {
